...
SOPTION4	TC	ERASCHK
SOPTION5	TC	SKEEP1		# WAS ROPECHK
SOPTION6	TC	SKEEP1
SOPTION7	TC	SKEEP1
...
STSHOSUM        CA      S+1              #  Initialize argument to 1
                DOUBLE
                DOUBLE
                DOUBLE
                DOUBLE
...
FB_NXT          CA      SKEEP4           #  Load argument into accumulator
                TS      SKEEP1

                TC      FOOBAR           #  Call Foobar routine
                TS      L                #  Store result in SKEEP1

                CA      S+ZERO           #  Load hardwired constant in SKEEP1
                TS      SKEEP2

  		TC	SDISPLAY         #  Call display routine

NXTBNK          INCR    SKEEP4           #  Increment argument and loop
                TC      FB_NXT


# REPLACE THE LOGIC TO COMPUTE MEMORY BACK CHECKSUMS WITH "DODGE THE LASERS" CODE
$foobarCode.agc
